...
for patient_dir in sorted(listdir(data_dir)):
    ...
    output1_path = output_path + "/T1_winsorized.mha"
    output2_path = output_path + "/T1_corrected.mha"
    print("Winsorizing {}. Saved to file {}".format(t1, output1_path))
    winsorize(t1, output1_path)
    print("Applying N4 correction {}. Saved to file {}".format(output1_path, output2_path))
    applyN4(output1_path, output2_path)

    output1_path = output_path + "/T1c_winsorized.mha"
    output2_path = output_path + "/T1c_corrected.mha"
    print("Winsorizing {}. Saved to file {}".format(t1c, output1_path))
    winsorize(t1c, output1_path)
    print("Applying N4 correction {}. Saved to file {}".format(output1_path, output2_path))
    applyN4(output1_path, output2_path)

    output1_path = output_path + "/T2_winsorized.mha"
    output2_path = output_path + "/T2_corrected.mha"
    print("Winsorizing {}. Saved to file {}".format(t2, output1_path))
    winsorize(t2, output1_path)
    print("Applying N4 correction {}. Saved to file {}".format(output1_path, output2_path))
    applyN4(output1_path, output2_path)

    output1_path = output_path + "/Flair_winsorized.mha"
    output2_path = output_path + "/Flair_corrected.mha"
    print("Winsorizing {}. Saved to file {}".format(flair, output1_path))
