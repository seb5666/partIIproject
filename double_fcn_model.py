...
def createModel(input_shape, tf_ordering=True, second_training_phase = False):
    ...
    path1 =  Convolution2D(64, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(inputs1)
    path1 = BatchNormalization(axis=axis)(path1)
    path1 = Activation('relu')(path1)

    path1 =  Convolution2D(64, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(path1)
    path1 = BatchNormalization(axis=axis)(path1)
    path1 = Activation('relu')(path1)

    path1 = MaxPooling2D(pool_size=(2,2), border_mode='valid')(path1)
    
    path1 =  Convolution2D(96, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(path1)
    path1 = BatchNormalization(axis=axis)(path1)
    path1 = Activation('relu')(path1)
    ...
    path2 = Convolution2D(32, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(inputs2)
    path2 = BatchNormalization(axis=axis)(path2)
    path2 = Activation('relu')(path2)

    path2 = Convolution2D(32, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(path2)
    path2 = BatchNormalization(axis=axis)(path2)
    path2 = Activation('relu')(path2)
   
    path2 = MaxPooling2D(pool_size=(2,2), border_mode='valid')(path2)
    
    path2 = Convolution2D(64, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(path2)
    path2 = BatchNormalization(axis=axis)(path2)
    path2 = Activation('relu')(path2)
    ...
    path2 = Convolution2D(96, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(path2)
    path2 = BatchNormalization(axis=axis)(path2)
    path2 = Activation('relu')(path2)
    ...
    predictions = Convolution2D(192, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(merged)
    predictions = BatchNormalization(axis=axis)(predictions)
    predictions = Activation('relu')(predictions)

    predicionts = Convolution2D(192, 3, 3, border_mode='same', init=init, W_regularizer=l2(l))(predictions)
    predictions = BatchNormalization(axis=axis)(predictions)
    predictions = Activation('relu')(predictions)
